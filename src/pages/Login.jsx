    ...
    try { 
      ...
      if (esRegistro) { 
        ...
        if (error) { 
          ...
          // "Guarda el nombre de usuario y su perfil en nuestra tabla especial."

          // Verifica si hubo un error al insertar el perfil en la base de datos.
          if (insertError) { 
            // "Si falló al guardar el perfil del usuario..."
            console.error("DETALLE DEL ERROR:", insertError); 
            // "Escribe en la consola técnica qué fue lo que falló exactamente."
            alert("Error de base de datos: " + insertError.message + " - Código: " + insertError.code); 
            // "Avisa al usuario y al desarrollador sobre el problema."
          } else { 
            // Si todo fue exitoso.
